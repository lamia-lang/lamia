...
async def check_validator_contracts(validator_class: Type[BaseValidator]) -> Tuple[bool, List[ContractViolation]]:
    """
    Convenience function to check validator contracts asynchronously.
    
    This is the main entry point for contract checking. It creates a checker
    instance and runs all contract checks for the given validator class.
