...
FILE_CONTEXT_TOOL_NAMES = {ToolName.LIST_FILES, ToolName.READ_FILE, ToolName.GLOB}
FILE_CONTEXT_TOOL_DEFINITIONS = [t for t in TOOL_DEFINITIONS if t["name"] in FILE_CONTEXT_TOOL_NAMES]
