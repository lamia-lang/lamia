...
class ValidationStrategyFactory:
    ...
    async def get_strategy(self, command_type: CommandType, validator_types: List[Type[BaseValidator]]) -> ValidationStrategy:
        ...
        strategy = await self._create_strategy(command_type, validator_types)
