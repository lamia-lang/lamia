...
class RetryingBrowserAdapter(BaseBrowserAdapter):
    ...
    def __init__(
        ...
        self.retry_handler = RetryHandler(retry_config, collect_stats=collect_stats)
    
    async def initialize(self) -> None:
        """Initialize the underlying adapter with retry."""
        await self.retry_handler.execute_with_retries(
    ...
    async def get_text(self, params: BrowserActionParams) -> str:
        """Get text with retry."""
        return await self.retry_handler.execute_with_retries(
